  ...
  return (
    <div className="py-10">
      <div className="flex flex-col items-center gap-4">
        <h1 className="text-2xl bg-teal-500 text-white py-2 w-80 text-center rounded-full font-semibold hover:bg-teal-600 cursor-pointer mt-6">
          Shop with S-MART
        </h1>
      ...
      <div className="max-w-screen-xl mx-auto py-10 grid sm:grid-cols-2 lg:grid-cols-4 gap-10">
        {products.map((item) => (
